...
export const profileUpdate = (user) => authenticatedHttp.patch('/users', user)

export const changeRole = (userId, cahngeRoleReq) => authenticatedHttp.patch(`/users/${userId}/change-role`, cahngeRoleReq)
